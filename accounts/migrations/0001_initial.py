    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.ImageField(blank=True, null=True, upload_to='images/profiles/avatars/')),
                ('email', models.EmailField(max_length=254, unique=True, verbose_name='email address')),
                ('bio', models.TextField(default='no bio...', max_length=400)),
                ('birthday', models.DateField(blank=True, null=True)),
                ('user_type', models.PositiveSmallIntegerField(blank=True, choices=[(1, 'User'), (2, 'Registration'), (3, 'Admin')], default=1, null=True)),
